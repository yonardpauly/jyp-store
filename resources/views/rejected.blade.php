...
@section('title', 'Feedback for Rejection')
				...
				<div class="row">
                    <div class="col-md-12">
                        <div class="overview-wrap">
                            <h2 class="display-4">Rejection message to customer</h2>
                        </div>
                        <hr>
                                ...
                                <form action="" method="post" class="">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control{{ $errors->has('sms') ? ' is-invalid' : '' }}" name="sms" placeholder="Enter your message here ..">We feel so sorry for the inconvenience of your order, we will try to fix it very soon! Thank you for your understanding.</textarea>
